(function (Drupal, drupalSettings) {
  ...
  console.log('=== Credibility Timeline Char      // Prepare datasets - show top 5 sources initially
      const datasets = timelineArray.slice(0, 5).map((sourceData, index) => {Script Loading ===');
