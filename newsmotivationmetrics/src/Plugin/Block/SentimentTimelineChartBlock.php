...
/**
 * Provides a 'Sentiment Timeline Chart' Block.
 *
 * @Block(
 *   id = "sentiment_timeline_chart",
 *   admin_label = @Translation("Sentiment Timeline Chart"),
 *   category = @Translation("News Motivation Metrics"),
 * )
 */
class SentimentTimelineChartBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a new SentimentTimelineChartBlock.
   */
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    ...
    $form['chart_settings']['days_back'] = [
      ...
      '#min' => 7,
      '#max' => 365,
      '#description' => $this->t('Number of days of sentiment data to display.'),
    ];
  ...
  public function build() {
    ...
    return $this->sentimentTimelineChartService->buildSentimentTimelineChart([
      'canvas_id' => 'sentiment-timeline-chart-block-' . substr(md5(serialize($config)), 0, 8),
      ...
      'container_classes' => ['timeline-chart-container', 'sentiment-timeline', 'sentiment-timeline-chart-block'],
  ...
  public function getCacheTags() {
    return ['newsmotivationmetrics:sentiment_timeline', 'newsmotivationmetrics:metrics'];
  }
